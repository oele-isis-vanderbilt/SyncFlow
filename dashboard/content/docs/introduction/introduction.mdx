...
<div className="text-center p-2 bg-white">
    <img src="/docs/syncflow-logo.png" alt="SyncFlow" className="mx-auto" />
</div>
...
<div className="flex flex-col items-center p-10">
    <img src="/docs/mmla.png"/>
    <p className="dark:text-white italic mt-2">Typical MMLA Collection Setup in different classroom environments</p>
</div>
<br/>
