      ...
      {linksToDisplay.map((link) => {
        ...
        return (
          <Link
            ...
            href={link.href}
            className={clsx(
              'flex h-[48px] grow items-center justify-center gap-2 rounded-md p-3 text-sm font-medium hover:text-blue-600 dark:text-white dark:hover:bg-gray-900 md:flex-none md:justify-start md:p-2 md:px-3',
              {
